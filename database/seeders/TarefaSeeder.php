    ...
    public function run()
    {
        DB::table('tarefa')->insert([
            ...
            ['titulo'=> 'Pintar', 'descricao'=>'Pintar a próxima Mona Lisa', 'dataInicio'=>'2026-09-24', 'dataTermino'=>'2026-10-24', 'status'=>'Pendente', 'prioridade'=>'Alta', 'categoria'=>'Lazer', 'usuario_id'=>'10'],
                ...
                ['titulo' => 'Treinamento de Cardio', 'descricao' => 'Realizar 45 minutos de corrida moderada na esteira e alongamento.', 'dataInicio' => '2026-09-24', 'dataTermino' => '2026-09-24', 'status' => 'Concluído', 'prioridade' => 'Média', 'categoria' => 'Saúde', 'usuario_id' => '2'],
                ...
                ['titulo' => 'Curso de Inglês Avançado', 'descricao' => 'Assistir às aulas de phrasal verbs e realizar os exercícios práticos.', 'dataInicio' => '2026-09-22', 'dataTermino' => '2026-09-28', 'status' => 'Em andamento', 'prioridade' => 'Média', 'categoria' => 'Estudos', 'usuario_id' => '9'],
                ...
                ['titulo' => 'Desenvolver API RESTful', 'descricao' => 'Criar rotas de autenticação com JWT e documentar com Swagger.', 'dataInicio' => '2026-09-23', 'dataTermino' => '2026-09-30', 'status' => 'Em andamento', 'prioridade' => 'Alta', 'categoria' => 'Trabalho', 'usuario_id' => '3'],
                ...
                ['titulo' => 'Maratona de Yoga', 'descricao' => 'Completar 5 sessões semanais de yoga para flexibilidade e foco.', 'dataInicio' => '2026-09-22', 'dataTermino' => '2026-09-28', 'status' => 'Em andamento', 'prioridade' => 'Baixa', 'categoria' => 'Saúde', 'usuario_id' => '8'],
